...
async function main() {
  ...
  // 8. Attribution Data
  await prisma.attributionData.createMany({
    data: [
      { source: 'Google Search Ads', firstTouchCount: 450, lastTouchCount: 200, linearReturn: 55000.00 },
      { source: 'CallRail Telephony', firstTouchCount: 50, lastTouchCount: 350, linearReturn: 42000.00 },
      { source: 'Meta Facebook Social', firstTouchCount: 300, lastTouchCount: 150, linearReturn: 28000.00 },
    ]
  });
